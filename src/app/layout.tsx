...
export const metadata: Metadata = {
  title: 'X Promo | Melhores Ofertas do Mercado Livre',
  description: 'Encontre as melhores ofertas e descontos em eletrônicos, casa, moda e muito mais. Promoções atualizadas do Mercado Livre com links de afiliado seguros.',
  keywords: 'ofertas, descontos, mercado livre, promoções, eletrônicos, casa, moda',
  authors: [{ name: 'X Promo' }],
